...
namespace Pulsar4X.SDL2UI
{
    ...
    public class Matrix
    {
        ...
        public Vector2 TransformToVector2(double itemx, double itemy)
        {
        ...
        public Vector2 TransformToVector2(Vector2 vector)
        {
            Vector2 newpoint2 = new Vector2();
        ...
        public Vector2[] TransformToVector2(ICollection<Vector2> vectors)
        {
            Vector2[] newpoints = new Vector2[vectors.Count];
            int i = 0;
        ...
        public SDL.SDL_Point[] TransformToSDL_Point(ICollection<Vector2> points)
        {
            SDL.SDL_Point[] newPoints = new SDL.SDL_Point[points.Count];
            int i = 0;
            foreach (var item in points)
